...
The next evidential milestone is that continuing practical capability: better complete outcomes or less total work across repeated use and consequential change, including acquisition, checking, failures and repair. All fifteen reviewed ancillary contributions have completed bounded phases; broader migration, correction, consolidation and acceptance questions remain open. A new [experience-guided investigation](notes/CONTINUING_EXPERIENCE_STUDY.md) is commissioned and prepared, with no model experiments started. It tests whether an adapter can learn investigation behavior from earlier attempts and improve later unfamiliar changes after fresh session resets, beyond competent artifact and source reuse. Complete acquisition and transfer come first; comparison with ordinary work and alternative resource use qualifies their practical value. Software maintenance supplies the first test setting. Root continues synthesis, literature and independent acceptance/intervention questions. The program's direction remains useful accumulated experience across sessions, with a clearer standard for demonstrating its value.
